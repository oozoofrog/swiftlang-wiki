...
| 2026-04-10 | publish | proposal-initializer-inheritance-to-modern-init-model.md, proposal-constructors-and-class-construction-to-init-model.md, mkdocs.yml, index.md, keyword-network.md | proposal crosswalks, init-model history | initializer inheritance와 rejected constructor/class-construction proposal을 현대 init 모델 문맥으로 연결하는 교차 읽기 페이지 추가 |
| 2026-04-10 | publish | proposal-c-export-and-bridging-to-importer.md, proposal-c-pointer-interop-to-unsafe-pointer-model.md, mkdocs.yml, index.md, keyword-network.md | proposal crosswalks, c-interop, pointers | AttrC와 C pointer interop proposal을 importer/UnsafePointer/bridging 문맥으로 연결하는 교차 읽기 페이지 추가 |
| 2026-04-10 | publish | proposal-in-place-operations-to-writeback-and-cow.md, proposal-optimizer-effects-and-attributes-to-sil-optimizer.md, proposal-option-sets-to-importer-and-layout.md, mkdocs.yml, index.md, keyword-network.md | proposal crosswalks, optimizer, value api, option sets | In-Place Operations, Optimizer Effects/Unsupported attrs, Option Sets proposal을 writeback/COW/optimizer/importer/layout 문맥으로 연결하는 교차 읽기 페이지 추가 |
| 2026-04-10 | update | swift-evolution-and-proposal-history.md 외 7개, mkdocs.yml, wiki-knowledge-chronicle.md | editorial, chronology, meta-separation | 지식 페이지에서 위키 내부 메타 서술을 줄이고, 별도 위키 지식 연대기 페이지 추가 |
...
| 2026-04-11 | infra | hooks/title_aware_wikilinks.py, mkdocs.yml, tests/test_title_aware_wikilinks.py | wikilinks, titles, rendering | bare wikilink가 slug 대신 대상 페이지의 실제 제목을 링크 텍스트로 쓰도록 build hook과 테스트 추가 |
