...
- In-Place Operations proposal 교차 읽기: [[proposal-in-place-operations-to-writeback-and-cow]]
- Optimizer Effects proposal 교차 읽기: [[proposal-optimizer-effects-and-attributes-to-sil-optimizer]]
...
- Enums / EnumStyle proposal 교차 읽기: [[proposal-enums-and-enum-style-to-type-system-and-layout]]
- TypeState proposal 교차 읽기: [[proposal-typestate-to-initialization-and-lifetime-model]]
- Option Sets proposal 교차 읽기: [[proposal-option-sets-to-importer-and-layout]]
...
- [[proposal-in-place-operations-to-writeback-and-cow|in-place operations]]
- [[proposal-optimizer-effects-and-attributes-to-sil-optimizer|optimizer effects]]
...
- [[proposal-enums-and-enum-style-to-type-system-and-layout|enums/enum style]]
- [[proposal-typestate-to-initialization-and-lifetime-model|typestate]]
- [[proposal-option-sets-to-importer-and-layout|option sets]]
...
- enum을 ADT/레이아웃/API 표면까지 함께 보고 싶다 → [[proposal-enums-and-enum-style-to-type-system-and-layout]] / [[swift-type-system]] / [[abi-type-layout]]
- ownership, borrow, lifetime, ARC를 한 장으로 먼저 잡고 싶다 → [[swift-ownership-memory-model]]
- typestate, invalidation, useful lifetime 같은 문제를 보고 싶다 → [[proposal-typestate-to-initialization-and-lifetime-model]] / [[swift-ownership-memory-model]]
...
- [[proposal-in-place-operations-to-writeback-and-cow|in-place operations proposal]]
- [[proposal-optimizer-effects-and-attributes-to-sil-optimizer|optimizer effects proposal]]
...
- mutating/non-mutating API와 writeback/COW 관계를 보고 싶다 → [[proposal-in-place-operations-to-writeback-and-cow]] / [[proposal-value-semantics-and-cow-to-ownership]]
- optimizer effect model과 언더스코어 속성 역사가 궁금하다 → [[proposal-optimizer-effects-and-attributes-to-sil-optimizer]] / [[high-level-sil-optimizations]]
...
- [[proposal-option-sets-to-importer-and-layout|option sets proposal]]
...
- `NS_OPTIONS` / `OptionSet` importer 역사가 궁금하다 → [[proposal-option-sets-to-importer-and-layout]] / [[how-swift-imports-c-apis]]
...
- in-place operations proposal이 writeback/COW와 어떻게 이어졌는지 보고 싶다 → [[proposal-in-place-operations-to-writeback-and-cow]]
- optimizer effects proposal이 `_effects`/specialization/inlining과 어떻게 이어졌는지 보고 싶다 → [[proposal-optimizer-effects-and-attributes-to-sil-optimizer]]
...
- enums / enum style proposal이 타입 시스템/API 표면/레이아웃과 어떻게 이어졌는지 보고 싶다 → [[proposal-enums-and-enum-style-to-type-system-and-layout]]
- typestate proposal이 initialization/lifetime/ownership 경계와 어떻게 이어졌는지 보고 싶다 → [[proposal-typestate-to-initialization-and-lifetime-model]]
- option sets proposal이 importer/layout과 어떻게 이어졌는지 보고 싶다 → [[proposal-option-sets-to-importer-and-layout]]
...
- proposal → implementation (in-place/value API)
  - [[proposal-in-place-operations-to-writeback-and-cow]] → [[proposal-value-semantics-and-cow-to-ownership]] → [[sil-memory-access]]
- proposal → implementation (optimizer/effects)
  - [[proposal-optimizer-effects-and-attributes-to-sil-optimizer]] → [[high-level-sil-optimizations]] → [[optimizer-design]]
...
- proposal → implementation (enum/type system)
  - [[proposal-enums-and-enum-style-to-type-system-and-layout]] → [[swift-type-system]] → [[abi-type-layout]]
- proposal → implementation (typestate/lifetime)
  - [[proposal-typestate-to-initialization-and-lifetime-model]] → [[proposal-initialization-and-accessors-to-property-model]] → [[swift-ownership-memory-model]]
- proposal → implementation (OptionSet/importer)
  - [[proposal-option-sets-to-importer-and-layout]] → [[how-swift-imports-c-apis]] → [[clang-importer]]
